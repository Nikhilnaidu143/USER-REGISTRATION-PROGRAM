...
public class UserRegistrationProblem {
	...
	public boolean firstNameValidation(String first_name) {
	...
	public boolean lastNameValidation(String last_name) {
	...
	public boolean mobileNumberValidation(String mobileNum) {
